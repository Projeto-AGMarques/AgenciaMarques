    ...
    <section id="faq_Screen">
        ...
        <div class="firstContainer_faq">
            <div class="card">
                ...
                <p class="textCard_faq">Pedidos e Entregas</p>
            </div>
            <div class="card">
                <div>
                ...
                <p class="textCard_faq">Formas de Pagamento</p>
            </div>
            <div class="card">
                <div>
                ...
                <p class="textCard_faq">Sobre o Local</p>
            </div>
            <div class="card">
                <div>
                ...
                <p class="textCard_faq">Devoluções</p>
            </div>
